...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-GUUT9SSJ.mjs");
...
var manifest = {
	"c29a850e44e3f0bb26018d58f134fc2b9015bbf12ab23aeac4ac9142bf347b2a": {
		functionName: "rescoreWithGrok_createServerFn_handler",
		importer: () => import("./api-EnfiDw8F.mjs")
	},
	"c2fe8d7a2d59aaf64f2fe1fd824cd1e29c29587b3f01e46ca259a4a2835963dc": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C0Kdu3Ct.mjs").then((n) => n.t),
